...
type Generator[T any] interface {
	...
	Enumerate(depth int) geniterable.Iterable[T]
}
...
type UntypedGenerator interface {
	...
	// Enumerate all elements of this type up to the given size
	Enumerate(depth int) geniterable.Iterable[interface{}]
}
...
type untypedGen struct {
	...
	enumerate func(depth int) geniterable.Iterable[interface{}]
}
...
func (u untypedGen) Enumerate(depth int) geniterable.Iterable[interface{}] {
...
func ToUntyped[T any](gen Generator[T]) UntypedGenerator {
	return untypedGen{
		...
		enumerate: func(depth int) geniterable.Iterable[interface{}] {
			return geniterable.Map(gen.Enumerate(depth),
				func(e T) interface{} {
					return e
				})
		},
